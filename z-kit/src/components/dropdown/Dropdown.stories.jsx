    ...
    render: () => (
        <Dropdown maxHeight={250}>
            <DropdownGroup>
                ...
                <GroupItem mode="icons" shortcut="ctrl a"><Disc color="red" />Apple</GroupItem>
    ...
    render: () => (
        <Dropdown search={true}>
            <DropdownGroup>
                ...
                <GroupItem mode="icons" shortcut="ctrl v">
                ...
                <GroupItem mode="icons" shortcut="ctrl x">
                ...
                <GroupItem mode="icons" shortcut="ctrl d">
            ...
            <DropdownGroup>
                ...
                <GroupItem mode="icons" shortcut="bsp" danger={true}>
        ...
        <Dropdown search={true}>
            <DropdownGroup>
                <QuickActions>
                    ...
                    <GroupItem mode="icons" danger={true}>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M10 11v6" /><path d="M14 11v6" /><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6" /><path d="M3 6h18" /><path d="M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2" /></svg>
                        delete
                    </GroupItem>
                </QuickActions>
